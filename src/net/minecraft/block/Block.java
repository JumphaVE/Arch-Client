...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if (Client.modManager.getByClass(XRay.class).isEnable()) {
            if (this == getBlockById(56)
                    || this == getBlockById(14)
                    || this == getBlockById(15)
                    || this == getBlockById(16)
                    || this == getBlockById(21)
                    || this == getBlockById(56)
                    || this == getBlockById(73)
                    || this == getBlockById(129)
                    || this == getBlockById(153)
            ) {
                return true;
            } else {
                return false;
